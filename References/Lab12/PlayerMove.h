...
public:
	...
	void SetDeathSound(SoundHandle soundHandle) { mDeathSound = soundHandle; }
...
protected:
	...
	// Sound Variables
	const std::string FOOTSTEPS_SOUND = "FootstepLoop.ogg";
	SoundHandle mFootsteps;

	const std::string JUMP_SOUND = "Jump.ogg";
	const std::string LAND_SOUND = "Land.ogg";
	const std::string TELEPORT_SOUND = "PortalTeleport.ogg";
	const std::string SHOOT_BLUE_SOUND = "PortalShootBlue.ogg";
	const std::string SHOOT_ORANGE_SOUND = "PortalShootOrange.ogg";
	const std::string PORTAL_FAIL_SOUND = "PortalFail.ogg";
	const std::string PORTAL_CLOSE_SOUND = "PortalClose.ogg";

	SoundHandle mDeathSound = SoundHandle::Invalid;
};
